...
# Time stamp on KeySub
time_map = {0: [1338, 1383], 1: [1408, 1456], 2: [1470, 1520], 3: [1536, 1588],
            4: [1598, 1650], 5: [1662, 1714], 6: [1724, 1780], 7: [1790, 1845],
            8: [1858, 1910], 9: [1917, 1975], 10: [1982, 2037], 11: [2045, 2100],
            12: [2110, 2168], 13: [2171, 2230], 14: [2237, 2293], 15: [2300, 2350]}
...
def process_key(position):
    ...
    hm = np.vectorize(hamming_weight)(iv)  # (20000, 256)
